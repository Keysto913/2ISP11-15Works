...
void play9L20Q15TVoid()
{
	...
	for (int i = 0; i < size; i++)
	{
		...
		if ((rightAnswer == 20 && wrongAnswer == 0) || (rightAnswer == 19 && wrongAnswer == 1) || (rightAnswer == 18 && wrongAnswer == 2) || (rightAnswer == 17 && wrongAnswer == 3) || (rightAnswer == 16 && wrongAnswer == 4) || (rightAnswer == 15 && wrongAnswer == 5) || (rightAnswer == 14 && wrongAnswer == 6) || (rightAnswer == 13 && wrongAnswer == 7) || (rightAnswer == 12 && wrongAnswer == 8))
		{
			cout << "\nВы победили, можете начать новую игру!!!" << endl;
			break;
		}
